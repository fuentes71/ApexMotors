...
export default function ForgotPasswordPage() {
  ...
  const handleResetPassword = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrorMsg("Ocorreu um erro ao solicitar a recuperação. Verifique se o e-mail está correto.");
    } finally {
      setIsLoading(false);
    }
  };
          ...
          {!isSuccess ? (
            <>
              <div className="mb-10 text-center">
                ...
                <p className="text-stone-500 font-medium">Informe seu e-mail e enviaremos instruções para criar uma nova senha.</p>
              </div>
            ...
            <div className="text-center py-6 animate-in zoom-in duration-500">
              ...
              <h2 className="text-2xl font-extrabold text-stone-900 tracking-tight mb-3">Verifique seu e-mail</h2>
              <p className="text-stone-500 font-medium mb-8">
                Enviamos um link mágico de recuperação para <br/>
